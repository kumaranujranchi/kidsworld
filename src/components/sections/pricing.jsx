...
const Card = ({ price, plan_name, features, is_center, id }) => {
    const INR_RATE = 83;
    const rupeePrice = Math.round(price * INR_RATE);
    return (
        <SlideUp delay={id}>
            <div className="rounded-[10px] shadow-[-20px_4.8px_24.4px_-6px_rgba(19,16,34,0.10)] bg-background ">
                ...
                <div className="lg:pt-7.5 pt-6 lg:pb-10 pb-7 lg:px-10 px-5">
                    <h2 className="lg:text-[70px] md:text-[50px] text-4xl lg:leading-[117%] md:leading-[110%] leading-[100%] font-bold text-green">₹{rupeePrice.toLocaleString('en-IN')}<span className="md:text-2xl text-lg font-semibold text-muted-foreground md:leading-[140%] leading-[130%]">/mo</span> </h2>
