        ...
        <footer className="pt-20 bg-[#0A6375] relative">
            <div className="container">
                <div className="grid lg:grid-cols-[300px_auto_auto_268px] sm:grid-cols-2 grid-cols-1 gap-x-7.5 gap-y-10 justify-between">
                    ...
                    <SlideUp delay={2}>
                        <Logo className="text-cream-foreground" textClassName="text-white" />
                        <div className="mt-10">
                            <p className="text-cream-foreground opacity-80 max-w-[320px] mt-2">Where learning is joyful, creative, and full of discovery — every day.</p>
                    ...
                    <SlideUp delay={4}>
                        ...
                        <ul className="flex flex-col lg:gap-[15px] gap-2.5 lg:pt-7.5 pt-5">
                            <li className="text-cream-foreground flex gap-4">
                                <FaLocationDot className='mt-1.5' /> <span className="max-w-[168px]">East Gola Road, Patna, Bihar, India 801503</span>
                            </li>
                            <li className="text-cream-foreground flex gap-4">
                                <FaEnvelope className='mt-1.5' /> <a href="mailto:hello@kidsworld.com" className="hover:text-primary-foreground transition-all duration-500">hello@kidsworld.com</a>
                            </li>
                            <li className="text-cream-foreground flex gap-4">
                                <FaPhone className='mt-1.5' /> <a href="tel:+919525230232" className="hover:text-primary-foreground transition-all duration-500">+91 9525230232</a>
                            </li>
                        </ul>
                    </SlideUp>
