...
const FooterOne = () => {
    return (
        <footer className="pt-[50px] sm:pt-[70px] pb-24 md:pb-28 relative">
            <div className="container">
                <div className="grid lg:grid-cols-[370px_auto_auto] sm:grid-cols-2 grid-cols-1 justify-between gap-7.5">
                    ...
                    <SlideUp delay={4}>
                        ...
                        <ul className="flex flex-col gap-[12px] sm:gap-[15px] pt-5">
                            <li>
                                <p className="text-[#686868] flex items-center gap-4">
                                    <span className="w-11 h-11 rounded-full border border-gray-200 flex justify-center items-center text-green-foreground"><FaLocationDot /></span> <span className="max-w-[230px] sm:max-w-[168px]">East Gola Road, Patna, Bihar, India 801503</span>
                                </p>
                            </li>
                            <li>
                                <p className="text-[#686868] flex items-center gap-4">
                                    <span className="w-11 h-11 rounded-full border border-gray-200 flex justify-center items-center text-green-foreground"><FaEnvelope /></span> <Link to="mailto:hello@kidsworld.com">hello@kidsworld.com</Link>
                                </p>
                            </li>
                            <li>
                                <p className="text-[#686868] flex items-center gap-4">
                                    <span className="w-11 h-11 rounded-full border border-gray-200 flex justify-center items-center text-green-foreground"><FaPhone /></span> <Link to="tel:+919525230232">+91 9525230232</Link>
                                </p>
                            </li>
                        </ul>
                    </SlideUp>
