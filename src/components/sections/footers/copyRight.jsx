    ...
    return (
        <div className="pt-[75px] overflow-x-hidden">
            <div className="flex lg:flex-row flex-col justify-between lg:items-center pt-7.5 pb-8 border-t border-t-white border-opacity-20">
                <p className={cn('wow fadeInLeft', color)} data-wow-delay=".3s">© <Link to="/">Kids World</Link> 2025 | All right researved</p>
                <ul className="flex items-center gap-7.5 wow fadeInRight" data-wow-delay=".3s">
                    ...
                    <li><a href="https://synergybrandarchitect.in" target="_blank" rel="noopener noreferrer" className={cn('', color)}>Design and Mainatined By - Synergy Brand Architect</a></li>
                </ul>
            </div>
        </div>
    )
