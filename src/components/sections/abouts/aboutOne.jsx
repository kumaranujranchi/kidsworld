                ...
                <div className={cn("grid lg:grid-cols-[60%_40%] grid-cols-1 items-center", gridClass)}>
                    <div className="relative">
                        <div className="flex sm:flex-row flex-col sm:items-end gap-6">
                            ...
                            <div className="flex sm:flex-col gap-8 mt-24 sm:mt-0">
                                ...
                                <div className="bg-background max-w-[212px] rounded-[11px] px-5 pt-[22px] pb-6 flex flex-col justify-center drop-shadow-[0px_4.8px_24.4px_rgba(19,16,34,0.10)] sm:mt-10 mt-8">
                    ...
                    <div className={`${isAboutpage ? "" : "lg:max-w-[439px]"} pt-7.5`}>
                        ...
                        <SectionDescription>We provide a safe, joyful environment where children explore, create, and develop strong academic and life skills. Our teachers use play-based methods and modern pedagogy to make every lesson engaging and meaningful.</SectionDescription>
