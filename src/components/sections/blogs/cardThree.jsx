        ...
        <SlideUp delay={2}>
            <div className="shadow-4xl bg-background rounded-[10px] group">
                ...
                <div className="pt-7.5 pb-10 lg:px-10 px-5">
                    <h4><Link to={"/blog-details"} state={{ src }} className="lg:text-[28px] sm:text-[26px] text-xl font-bold lg:leading-[148%] sm:leading-[140%] leading-[120%] group-hover:text-secondary-foreground transition-all duration-500">{title}</Link></h4>
                    <div className="lg:mt-10 mt-7">
                        <Button asChild variant={"outline"}>
                            <Link to={"/blog-details"} state={{ src }}>Read More</Link>
                        </Button>
                    </div>
