...
// Updated external images per user request
                        ...
                        <div className="relative">
                            <div className="absolute top-1/2 -translate-y-1/2 h-full flex flex-col justify-between">
                                <div className="mt-[68px] sm:w-full w-40 animate-up-down">
                                    <img src="https://imagizer.imageshack.com/img923/4479/NvVt5p.png" alt="contact secondary image" />
                                </div>
                            ...
                            <div className="flex lg:justify-end justify-center">
                                <img src="https://imagizer.imageshack.com/img924/4458/LGpt08.png" alt="contact main image" />
                            </div>
                        </div>
                        <div>
